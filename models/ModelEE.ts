...
export class ModelEE {
    ...
    getAllData( beforeImg,img,afterImg,adempimentoEE, AdeguamentoNicchiaCaricoCliente,retroPDF){
    ...
    public getTesProvDomDefinition(value): Promise<any> {
        ...
        // Tipo servizio
        var servizio = 'Servizio: Gas [__]       Energia Elettrica [ X ]';    

        // Codice Rintracciabilità / TICA
        var codice_rintracciabilita_label,codice_rintracciabilita_value;
        if (value.download.ads.ActiveConnection) {
            codice_rintracciabilita_label = {text: 'Codice TICA ', bold: true , border:[false, false, false, false]}; 
            codice_rintracciabilita_value = {text: vs.TICA, border:[false, false, false, true]};
        }
        else 
        {
            codice_rintracciabilita_label = {text: 'Codice di rintracciabilità ', bold: true , border:[false, false, false, false]}; 
            codice_rintracciabilita_value = {text: value.dati.form.Rintracciabilita, border:[false, false, false, true]};
        }
        ...
        */
        ...
        // Sotto Prestazione
        var tipo_preventivo = "Sotto Prestazione: "+value.download.ads.GetTipoPreventivoLabel();
        ...
        var beforeImg = [                   
                            {
                                table: {
                                        ...
                                        table: {
                                            widths: [90, '*', 40 ,'*'],
                                            body: [
                                                [ codice_rintracciabilita_label,
                                                  codice_rintracciabilita_value,  
                                    ...
                                    },
                                    {
                                        ...
                                        table: {
                                            ...
                                            body: [
                                                ...
                                                {text: "",fontSize: 5},
                                                {text: "",fontSize: 5},
                                                {text: 'CONTATORI RICHIESTI',colSpan:'6', fontSize: 5},
                                                {text: "",fontSize: 5},
                                                {text: "",fontSize: 5},
                                                {text: "",fontSize: 5},
                                                {text: "",fontSize: 5},
                                                ...
                                                {text: value.dati.form.Variante_Fasi,fontSize: 5}, 
                                                ...
                                                {text: value.dati.form.Variante_Fasi_2,fontSize: 5}, 
                                                ...
                                                {text: value.dati.form.Variante_Fasi_3,fontSize: 5}, 
                ...
                content: [
                    {
                        ...
                        table: {
                            ...
                            body: [
                                    [
                                    {
                                        stack: this.getAllData(beforeImg,this.getSezioneImg(value),afterImg,adempimentoEE,value.dati.form.AdeguamentoNicchiaCaricoCliente ,retroEE)
                                    },
                                    ]
                                ]
                                }
